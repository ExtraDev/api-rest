...
export default (router: Router) => {
    ...
    router.get("/tasks/:id", logAction, isAuthenticated, isParamsSetted, taskController.getTask);

    router.post("/tasks", logAction, isAuthenticated, isBodySetted, taskController.createTask);

    router.put("/tasks/:id", logAction, isAuthenticated, isParamsSetted, isBodySetted, taskController.updateTask);
}